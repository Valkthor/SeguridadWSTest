...
namespace BorrarDespuesDeterminar.Models
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=VALK2-PC\\SQLEXPRESS01; Initial Catalog=BookStoresDB;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F2224A406F76");
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__RefreshTo__user___3E52440B");
            });
